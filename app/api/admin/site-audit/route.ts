...
export async function GET(request: Request) {
  ...
  const checks: AuditCheckItem[] = [
    ...
    },
    {
      ...
      description: "Auditoria contínua de rotas de catálogo, produto, carrinho, receitas e institucional.",
      status: "passed",
      score: 100,
    ...
    },
    {
      ...
      recommendation: "APIs e dados de receitas médicas protegidos contra indexação indevida.",
    },
    {
    ...
    {
      id: "ux-prescription-cta",
      pillar: "ux_conversion",
      source: "Shopify Benchmark",
      title: "Botão de Destaque para Envio de Receitas",
      description: "Fluxo desimpedido e visível para medicamentos sob prescrição e controlados.",
      status: "passed",
      score: 100,
      metric: "CTA Destaque Topo",
      recommendation: "Garante retenção de receitas médicas de alto ticket.",
    },
    {
