  ...
  return (
    <div className="catalog-layout">
      <aside className="catalog-filters" aria-label="Filtros do catálogo">
        ...
        <div className="filter-note"><Icon name="shield" /><p><strong>Compra responsável</strong>Medicamentos com exigência de receita passam por análise farmacêutica.</p></div>
      </aside>
