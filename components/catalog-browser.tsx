  ...
  return (
    <div className="catalog-layout">
      <aside className="catalog-filters" aria-label="Filtros do catálogo">
        ...
        <div className="filter-note"><Icon name="shield" /><p><strong>Compra sem burocracia</strong>Catálogo 100% isento de retenção de receita com entrega rápida e procedência garantida.</p></div>
      </aside>
